...
- **"Checking our info"** — the assistant is looking the answer up in *your* knowledge base
  (facts you wrote), not making something up. If it can't find an answer, it says so and
...
| It will | It won't |
| --- | --- |
| Answer questions using facts you provided | Guess when it doesn't know |
| Suggest items from your live menu | Quote prices you haven't published |
| Stay polite when someone isn't | Play along with abuse or off-topic requests |
| Work at 3 AM | Promise callbacks or take actions you haven't enabled |

## What running it looks like

You manage everything from one admin page — no coding: what the assistant knows, how it
sounds, which websites it appears on, and a daily message limit that caps what a day of chat
can ever cost you.

Next: [Set it up, step by step](./setup).
